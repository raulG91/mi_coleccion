...
platforms = [('Master System','Master system'),('Nintendo Nes','Nintendo Nes'),('PC Engine','PC Engine'),('Megadrive','Megadrive'),('Super Nintendo','Super Nintendo'),('Game boy','Game boy'),('Game boy advance','Game boy advance'),
...
buyer = [('Amazon','Amazon'),('Game','Game'),('El corte ingles','El Corte Ingles'),('Media Markt','Media Markt'),
                                                      ...
                                                      ('Carrefour','Carrefour'),('Ebay','Ebay'),('Wallapop','Wallapop'),('Vinted','Vinted'),('Eneba','Eneba'),('Tienda fisica','Tienda fisica'),('Otra','Otra')]
